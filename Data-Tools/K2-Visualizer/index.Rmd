---
title: "Supplementary Material for 'Lexidate Selection Analysis: Unaggregating Cross-Validation K2 Results'"
...
The code used for this supplemental material can be found in [this GitHub repository](https://github.com/jgh9094/lexidate-cv-analysis).
